...
class JoinsDriver implements GlobalConst {
  ...
  public JoinsDriver() {
    ...
    String file_name = "/Users/blakepatterson/Downloads/data3.txt";
    ...
    try {
      ...
      int [] pref_list = {0,1,2,3,4};
      int numOfPages = 5;
      short[] x = {};
      //+++++++++ Uncomment to test NestedLoopsSky ++++++++++++++++++++++++++++++++++++++++
      ...
      try
      {
        ...
        {
          float check = (float) 0.9955844;
          if((float)t.getFloFld(1) == check){
            boolean check1 = true;
          }
