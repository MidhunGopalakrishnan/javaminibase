...
public class BT  implements GlobalConst{
  ...
  public static void printPage(PageId pageno, int keyType)
            ...
            InvalidFrameNumberException
    {
	  ...
	  i++;    
        ...
        HashLeafPage leafPage=new HashLeafPage((Page)sortedPage, keyType);
        System.out.println("");
   ...
   */
  public static void printBTree(HashHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   IteratorException,
	   HashEntryNotFoundException,
   ...
   *@exception ReplacerException  error from lower layer
   */
  public static void printAllLeafPages(HashHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   IteratorException,
	   HashEntryNotFoundException,
