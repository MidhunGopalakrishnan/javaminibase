...
//    */
//   public UnclusteredHashFile(String filename, int keytype,
...
// 	{
// 	  HashLeafPage currentLeafPage = 
// 	    new HashLeafPage(page, headerPage.get_keyType() );
...
// 	    {
// 	      HashLeafPage rightPage;
// 	      rightPage=new HashLeafPage(rightPageId, headerPage.get_keyType());
...
//   HashLeafPage findRunStart (KeyClass lo_key, 
// 			   RID startrid)
//     throws IOException, 
// 	   IteratorException,  
// 	   KeyNotMatchException,
...
//       pageLeaf = new HashLeafPage(page, headerPage.get_keyType() );
...
// 	pageno = nextpageno; 
// 	pageLeaf=  new HashLeafPage( pinPage(pageno), headerPage.get_keyType());    
// 	curEntry=pageLeaf.getFirst(startrid);
//       }
...
// 	  leafPage=new HashLeafPage(pinPage(nextpage), 
// 				  headerPage.get_keyType() );
...
// 	leafPage=new HashLeafPage(pinPage(nextpage), headerPage.get_keyType());
...
//         PageId nextpage;
//         HashLeafPage leafPage;
//         leafPage=new HashLeafPage(page, headerPage.get_keyType());        
...
//               siblingPage=new HashLeafPage(pinPage(siblingPageId), 
// 					 headerPage.get_keyType());
...
// 		HashLeafPage leftChild, rightChild;
// 		if (direction==-1) {
...
// 		  HashLeafPage nextLeafPage=new HashLeafPage(
...
// 	  HashLeafPage leafPage=new HashLeafPage(sortedPage,headerPage.get_keyType()); 
